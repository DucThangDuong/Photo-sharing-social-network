...
class SummaryUserGuest extends StatefulWidget {
  ...
  @override
  State<SummaryUserGuest> createState() => _UserSuggestionTileState();
}

class _UserSuggestionTileState extends State<SummaryUserGuest> {
  ...
  Widget build(BuildContext context) {
    final currentUser = context
        .read<UserProvider>()
        .user;
    String avatarUrl = widget.user.avatarUrl != null &&
          ...
          children: [
            ...
            CircleAvatar(
              ...
              child: avatarUrl.isEmpty ? const Icon(
                  Icons.person, color: Colors.white, size: 28) : null,
            ),
